  ...
  return (
    <footer className="mt-4 w-full max-w-full overflow-hidden border-t border-slate-200 bg-slate-100 text-black">
      <div className="flex w-full max-w-full flex-col items-center gap-1 p-3">
        <img
          src="/logo__rojo.png"
          alt="Logo de Grupo Castro Fallas, agencia aduanal y logística internacional"
          width="60"
          height="60"
          loading="lazy"
          decoding="async"
        ...
        <div className="mt-1 flex items-center justify-center gap-2.5">
          <a href="https://es-la.facebook.com/grupocastrofallas1/" target="_blank" rel="noopener noreferrer" aria-label="Facebook de Grupo Castro Fallas" className={socialClass}>
            <svg className="block h-3 w-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
              <path d="M14 8h3V4h-3c-3.3 0-5 1.7-5 5v3H6v4h3v8h4v-8h3l1-4h-4V9c0-.7.3-1 1-1z" />
            </svg>
          </a>

          <a href="https://twitter.com/castrofagrupo" target="_blank" rel="noopener noreferrer" aria-label="X de Grupo Castro Fallas" className={socialClass}>
            <svg className="block h-3 w-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
          ...
          <a href="https://www.instagram.com/grupocastrofallas1/" target="_blank" rel="noopener noreferrer" aria-label="Instagram de Grupo Castro Fallas" className={socialClass}>
            <svg className="block h-3 w-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" aria-hidden="true">
          ...
          <a href="https://www.linkedin.com/company/grupo-castro-fallas/" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn de Grupo Castro Fallas" className={socialClass}>
            <svg className="block h-3 w-3" viewBox="0 0 24 24" fill="currentColor" aria-hidden="true">
