...
const category: CategoryItem[] = [
  {
    icon: "/transporteMaritimo__negro.png",
  ...
  {
    icon: "/transporteterrestre__negro.png",
  ...
  {
    icon: "/transporteAereo__negro.png",
...
const category2: CategoryItem[] = [
  ...
  {
    icon: "/segurosdecarga__negro.png",
        ...
        <div className="mt-20">
          <div className="mx-auto mb-10 max-w-2xl text-center">
            ...
            <p className="mx-auto mt-4 text-[15px] leading-7 text-slate-500">
              Soluciones adicionales para acompañar cada etapa de tu operación
              logística.
            </p>
          </div>
                  ...
                  <aside className="space-y-4">
                    {[
                      [
                        "✓",
                        "Seguridad",
                        "Gestión orientada a proteger la carga durante cada etapa del proceso.",
                      ],
                      [
                        "◎",
                        "Cobertura",
                        "Conexiones y soluciones adaptadas a operaciones nacionales e internacionales.",
                      ],
                      [
                        "↗",
                        "Eficiencia",
                        "Coordinación enfocada en optimizar tiempos y procesos logísticos.",
                      ],
                    ].map(([icon, title, text]) => (
                      <div
                        key={title}
