...
function QuotePage() {
  ...
  const availableDestinations = offices.filter(
    (office) => office.label !== origin
  )
            ...
            <div className="quote-welcome">
              ...
              <div className="quote-options">
                ...
                <button
                  type="button"
                  onClick={() =>
                    setService('Transporte marítimo')
                  }
                >
                  <span className="quote-option-icon">
                    🚢
                ...
                <button
                  type="button"
                  onClick={() =>
                    setService('Transporte terrestre')
                  }
                >
                  <span className="quote-option-icon">
                    🚚
              ...
              <div className="quote-welcome">
                ...
                <div className="quote-options quote-cargo-options">
                  ...
                  <button
                    type="button"
                    onClick={() =>
                      setCargoType('Carga refrigerada')
                    }
                  >
                    <span className="quote-option-icon">
                      ❄️
          ...
          {service &&
            ...
            !dimensionsComplete && (
              <div className="quote-welcome">
                ...
                <p>
                  Ingresa la información aproximada. Nuestro equipo de Pricing
                  podrá confirmar los datos posteriormente.
                </p>
          ...
          {service &&
            ...
            !reviewReady && (
              <div className="quote-welcome">
                ...
                <p>
                  Agrega cualquier detalle especial que pueda ayudar a nuestro
                  equipo de Pricing a preparar tu cotización.
                </p>
          ...
          {service &&
            ...
            reviewReady && (
              <div className="quote-welcome">
                ...
                <p>
                  Verifica la información antes de preparar el correo para
                  nuestro equipo de Pricing.
                </p>
